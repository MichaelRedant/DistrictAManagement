    ...
    <div id="revolutionSlider" class="slider manual rev_slider" data-version="5.4.8">
        <ul>
            <li data-transition="fade">
                <img src="{{asset('frontend/img/demos/one-page-agency/slides/slide-1.jpg')}}"
                    alt=""
                ...
                <h1 class="tp-caption text-color-light font-weight-bold"
                    ...
                    data-start="500"
                    data-fontsize="80"
                    data-transform_in="y:[-300%];opacity:0;s:500;">Winkelen in Aalst</h1>
                ...
                <div class="tp-caption text-color-light"
                    ...
                    data-mask_in="x:0px;y:0px;">goed idee!</div>

            </li>
            <li data-transition="fade">
                <img src="{{asset('frontend/img/demos/one-page-agency/slides/slide-2.jpg')}}"
                    alt=""
                    data-bgposition="center center"
                    data-bgfit="cover"
                    data-bgrepeat="no-repeat"
                ...
                <h1 class="tp-caption text-color-light font-weight-bold"
                    ...
                    data-start="500"
                    data-fontsize="80"
                    data-transform_in="y:[-300%];opacity:0;s:500;">Eten en Drinken in Aalst</h1>
                ...
                <div class="tp-caption text-color-light"
                    ...
                    data-transform_in="y:[100%];s:500;"
                    data-transform_out="opacity:0;s:500;"
                    data-mask_in="x:0px;y:0px;">Gezellig kuieren</div>
