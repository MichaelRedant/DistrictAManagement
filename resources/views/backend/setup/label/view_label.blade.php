        ...
        <div class="row">
           ...
           <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Lijst met Labels</h3>
                <a href="{{route('leden.label.add')}}" style="float:right;" class="btn btn-rounded btn-success mb-5">Label Toevoegen</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                          @foreach ($allData as $key => $label )
                            <tr>
                              <td>{{ $key+1 }}</td>
                              <td>{{ $label->name }}</td>
                              <td>
                                  <a href="{{route('leden.label.edit',$label->id)}}" class="btn btn-light mb-5 mr-3">Edit</a>
                                  <a href="{{route('leden.label.delete',$label->id)}}" class="btn btn-danger mb-5" id="delete">Delete</a>
                              </td>
                          </tr>
                          @endforeach           
                      </tbody>
